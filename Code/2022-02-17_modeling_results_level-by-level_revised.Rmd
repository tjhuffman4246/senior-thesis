---
title: 'Modeling and Figures: Level-by-Level, Revised'
author: "Tate Huffman"
date: "2/17/2022"
output: pdf_document
---
...
level_num <- 2 # 1 corresponds to Rookie, 2 to Short-Season-A, ..., 7 to MLB
...
player_mvmt_filtered %>% 
  select(-cell) %>% 
  write_csv("../Scratch/2022-02-17 Results/Short-Season A/2022-02-17_result_probs_short-season-a.csv")

params <- tibble(
  a = a_pred,
  b = b_pred,
  theta_0 = theta_0_pred,
  alpha = alpha_pred,
  tau = tau_pred
)

params %>% 
  write_csv("../Scratch/2022-02-17 Results/Short-Season A/2022-02-17_result_params_short-season-a.csv")
