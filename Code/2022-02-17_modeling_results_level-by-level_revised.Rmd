...
level_num <- 6 # 1 corresponds to Rookie, 2 to Short-Season-A, ..., 7 to MLB
...
init_guess <- c(45, 45, 0.1, 0.3, 0.2)
...
player_mvmt_filtered %>% 
  select(-cell) %>% 
  write_csv("../Scratch/2022-02-17 Results/AAA/2022-02-17_result_probs_aaa.csv")
...
params %>% 
  write_csv("../Scratch/2022-02-17 Results/AAA/2022-02-17_result_params_aaa.csv")
