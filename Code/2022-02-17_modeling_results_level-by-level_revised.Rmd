...
level_num <- 1 # 1 corresponds to Rookie, 2 to Short-Season-A, ..., 7 to MLB
...
player_mvmt_filtered %>% 
  select(-cell) %>% 
  write_csv("../Scratch/2022-02-17 Results/Rookie/2022-02-17_result_probs_rookie.csv")
...
params %>% 
  write_csv("../Scratch/2022-02-17 Results/Rookie/2022-02-17_result_params_rookie.csv")
