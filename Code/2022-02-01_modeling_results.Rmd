...
We now want to examine how accurate these predictions are. First, we add the above info to the player movemnt table, and then we use `ggplot` to examine it visually.
